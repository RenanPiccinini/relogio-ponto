                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('editar-funcionario-post', $user->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        <label for="password" class="mt-2">Nova senha</label>
                                    ...
                                    <div class="form-group" class="mt-2">
                                        <label for="password-confirm">Repita a nova senha</label>
                                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                                    </div>

                                    <button type="submit" class="btn btn-primary mt-3">Editar Funcionário</button>
                                </form>
